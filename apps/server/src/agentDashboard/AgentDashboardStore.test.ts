      ...
      await NodeFSP.writeFile(
        ...
        JSON.stringify({
          suggestions: [
            ...
            {
              id: "not-a-review",
              title: "Native activity should not surface here",
            ...
            {
              id: "missing-run-id",
              title: "Unscoped review record should not surface here",
              source: "code_review",
              profile: "t3-random-codebase-review",
              status: "pending",
              created_at: createdAt,
            ...
            },
            {
              ...
              title: "Legacy review record should not surface here",
              source: "code_review",
              job_id: "legacy-hermes-run",
              status: "pending",
              created_at: createdAt,
              repository: { name: "repository", path: repositoryPath },
            },
