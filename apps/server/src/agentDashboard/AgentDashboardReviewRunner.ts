...
export const buildReviewPrompt = (
  ...
  [
    ...
    'T3_REVIEW_METADATA: {"findings":[{"title":"...","type":"bug|security|research|improvement|operations|review","category":"specific subsystem or concern","summary":"...","impact":"...","confidence":"high|medium|low","evidence":["path:line and concrete evidence"],"next_step":"...","readiness":"ready|needs-research","targets":[{"path":"...","symbol":null,"evidence":"..."}],"validation_plan":["..."],"sources":[{"title":"...","url":"...","kind":"documentation|paper|issue"}],"automation_risk":"low|medium|high|critical","estimated_effort":"small|medium|large","qualification_reason":"why this is ready","github_issue_title":"...","github_issue_body":"complete preformatted Markdown issue body","markdown":"optional Markdown finding"}],"qualifications":[{"finding_id":"exact id from the candidate list","outcome":"ready|needs-research|dismiss","proposal":"bounded next step","expected_value":"concrete benefit","targets":[{"path":"...","symbol":null,"evidence":"..."}],"validation_plan":["..."],"sources":[],"automation_risk":"low|medium|high|critical","estimated_effort":"small|medium|large","reason":"why this outcome is correct"}]}',
